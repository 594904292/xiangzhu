...
class sqlitehelp: NSObject {
    ...
    func addts(infoid:String,userid:String)
    {
        var db: SQLiteDB! = SQLiteDB.sharedInstance()
    ...
    func removets(infoid:String,userid:String)->Bool
    {
        var db: SQLiteDB! = SQLiteDB.sharedInstance()
    ...
    func isexitts(infoid:String,userid:String)->Bool
    {
        var db: SQLiteDB! = SQLiteDB.sharedInstance()
    ...
    func addmemberts(memberid:String,userid:String)
    {
        var db: SQLiteDB! = SQLiteDB.sharedInstance()
    ...
    func removememberts(memberid:String,userid:String)->Bool
    {
        var db: SQLiteDB! = SQLiteDB.sharedInstance()
    ...
    func isexitmemberts(memberid:String,userid:String)->Bool
    {
        var db: SQLiteDB! = SQLiteDB.sharedInstance()
