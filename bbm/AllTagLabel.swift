...
class AllTagLabel: UIView {
    ...
    func display(){
        ...
        for var index = 0; index < textArray?.count; index += 1 {
            ...
            var tap = UITapGestureRecognizer(target:self, action:"seltapLabel:");
